...
def trail(): #User cna go left or right
    print ("You are now walking on the trail!")
    print ("HOWEVER the trial forks left and right!")
...
def cave_in(): #Transfer to cave part of story
...
def quicksand(): #User can struggle or let it happen
    print ("You have walked for an hour on the path.")
